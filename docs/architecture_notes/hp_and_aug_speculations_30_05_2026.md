...
Built 2026-05-31, retired 2026-06-02 (see `bst_x_sweep_summary_wd_x_focal_alpha_revert.md`), ripped 2026-07-01. Reversal path: `docs/architecture_notes/focal_alpha_revert_sketch.md`. The scripts, tables and figures that motivated it are in `docs/architecture_notes/alpha_arc_analysis/`. The design bullets below are the ones that drove the shape it landed at:
