...
Add a forward pointer to `docs/architecture_notes/completed_general_refactors/dir_flatten_refactor.md` from `pipeline/README.md` and `data_pipeline_to_model_train.md`.
