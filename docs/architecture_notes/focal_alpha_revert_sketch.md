...
**Removed:** 2026-07-01. The extension wiring, tests, config forwarding, and live-wiring docs came out across Batches 1-6 of the `remove-adaptive-focal-extensions` branch. Final code-removal commit: `914e60c` (adaptive_focal.py extensions). Merged into main at `39e72a5`.
