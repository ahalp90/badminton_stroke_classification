"""Bit-exact comparison of prepare_2d_dataset_npy_from_raw_video across two code states.

Runs ``_prepare_dataset_from_raw_video`` (via the public
...
Optional env vars:
  ATOL_FLOAT  -- tolerance for _pos and _joints (default: 1e-5; absorbs
                 projection-chain float32 -> float64 non-associativity)
