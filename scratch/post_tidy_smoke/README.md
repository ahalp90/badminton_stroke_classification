...
| BST model graph + `bst_common.build_bst_network` | 2-epoch smoke train within run-to-run noise |

## What these scripts close

| Script | Surface | Cost | Why it's needed |
|---|---|---|---|
| `smoke_infer_bit_exact.py` | `bst_infer.py` (build_bst_network adoption) | ~10 min, venv-bst | Inference path was not exercised by any other gate |
